...
# Google Snake-inspired color palette
BG_COLOR = (105, 174, 95)          # Soft green background
GRID_COLOR = (120, 188, 110)       # Slightly lighter grid
SNAKE_HEAD = (34, 100, 34)         # Dark green head
SNAKE_BODY = (55, 135, 50)         # Green body
SNAKE_BODY_ALT = (45, 120, 42)     # Alternate segments
SNAKE_OUTLINE = (25, 75, 25)       # Dark outline
FOOD_COLOR = (210, 60, 50)         # Red food
FOOD_GLOW = (255, 100, 80)         # Food glow
FOOD_HIGHLIGHT = (255, 160, 140)   # Food highlight
TEXT_COLOR = (255, 255, 255)        # White text
TEXT_SHADOW = (25, 75, 25)          # Dark shadow
GRID_LINE_ALPHA = 20
...
# Grid surface for semi-transparent lines
